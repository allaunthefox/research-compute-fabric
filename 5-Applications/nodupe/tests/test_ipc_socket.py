"""Test module for IPC socket communication with NoDupe tools.

This module provides functions to test the IPC socket interface for communicating
with various NoDupe tools via Unix domain sockets.
"""
...
def test_ipc_call(tool, method, params=None):
    """Test IPC call to a tool via Unix socket.

    Args:
        tool: The name of the tool to call.
        method: The method name to invoke on the tool.
        params: Optional dictionary of parameters to pass to the method.

    Returns:
        The JSON response from the tool, or None if the call fails.
    """
