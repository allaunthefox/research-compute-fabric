...
`5-Applications/scripts/cadref` resolves prompt-ready `@cad[...]` refs directly from STEP entries.
...
- `5-Applications/scripts/cadref` resolves STEP refs from STEP files and generated selector artifacts.
