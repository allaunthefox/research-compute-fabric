...
class GeoWeirdSwarmOrchestrator:
    ...
    def run_collaboration_round(
        ...
        for agent_a, agent_b in pairs:
            ...
            # Step 3: Both agents initiate collaboration
            context_a = agent_a.initiate_collaboration(agent_b, task)
            context_b = agent_b.initiate_collaboration(agent_a, task)
