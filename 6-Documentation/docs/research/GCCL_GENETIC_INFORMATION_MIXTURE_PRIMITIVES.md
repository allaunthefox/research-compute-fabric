> **NOTE:** This document overlaps with `MISC_GENETIC_NSPACE.md`. The authoritative treatment is `MISC_GENETIC_NSPACE.md` (the GENSIS framework). This document is retained for historical reference. See `docs/research/FRAMEWORK_RELATIONSHIPS.md` for context.
